...
import { useCabinsOpen } from '../cabin/useCabinsOpen';
import CabinsList from '../CabinsList_42';

function Landing_42() {
  const { cabins, isLoading } = useCabinsOpen();
  console.log('Landing_42 cabins', cabins);
  return (
    <>
          ...
          <header className='border-b border-primary-900 px-8 py-5'>
            <div className='flex justify-between items-center max-w-7xl mx-auto'>
              <Link className='flex items-center gap-4 z-10' to='/'>
                ...
                <span>The Wild Oasis (211410542)</span>
              </Link>
